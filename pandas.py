...
<html lang="en">
  ...
  <title>acadview-assignments/pandas.py at master · bhartigupta63/acadview-assignments</title>
  ...
  <link rel="web-socket" href="wss://live.github.com/_sockets/VjI6MzE2NzQ3NzcxOmRjMDIyMzc3YWI0ZDJlOWRlYzczZjlhNDJiZTI2YzZlZDI4YjBhNjdlMmM0MDQ2Mzg5Yjc2YjYwZGNhZDJiNGQ=--de8ab61e238cce08678e997898bc661117fb70c9">
  <meta name="pjax-timeout" content="1000">
  <link rel="sudo-modal" href="/sessions/sudo_modal">
  <meta name="request-id" content="76D7:0CEB:1582F8:2109E3:5B996459" data-pjax-transient>
...
<meta class="js-ga-set" name="dimension1" content="Logged In">
    ...
    <meta name="js-proxy-site-detection-payload" content="YzU5YjRlZDUyODY1ODBhMWU5ZjZkNWMwNDIwMThmZmM5ZTBjYzM2NjFlNzkwODdmMGNhYThhZTY5NWJlOTFmYnx7InJlbW90ZV9hZGRyZXNzIjoiMTAzLjcyLjEwLjE2MSIsInJlcXVlc3RfaWQiOiI3NkQ3OjBDRUI6MTU4MkY4OjIxMDlFMzo1Qjk5NjQ1OSIsInRpbWVzdGFtcCI6MTUzNjc3OTM5MiwiaG9zdCI6ImdpdGh1Yi5jb20ifQ==">
  ...
  <meta name="octolytics-dimension-user_id" content="40464523" /><meta name="octolytics-dimension-user_login" content="bhartigupta63" /><meta name="octolytics-dimension-repository_id" content="138185210" /><meta name="octolytics-dimension-repository_nwo" content="bhartigupta63/acadview-assignments" /><meta name="octolytics-dimension-repository_public" content="true" /><meta name="octolytics-dimension-repository_is_fork" content="false" /><meta name="octolytics-dimension-repository_network_root_id" content="138185210" /><meta name="octolytics-dimension-repository_network_root_nwo" content="bhartigupta63/acadview-assignments" /><meta name="octolytics-dimension-repository_explore_github_marketplace_ci_cta_shown" content="false" />
    ...
    <link rel="canonical" href="https://github.com/bhartigupta63/acadview-assignments/blob/master/pandas.py" data-pjax-transient>
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="js-site-search-form" data-scope-type="Repository" data-scope-id="138185210" data-scoped-search-url="/bhartigupta63/acadview-assignments/search" data-unscoped-search-url="/search" action="/bhartigupta63/acadview-assignments/search" accept-charset="UTF-8" method="get"><input name="utf8" type="hidden" value="&#x2713;" />
      <label class="form-control header-search-wrapper header-search-wrapper-jump-to position-relative d-flex flex-justify-between flex-items-center js-chromeless-input-container">
        <input type="text"
          ...
          data-jump-to-suggestions-path="/_graphql/GetSuggestedNavigationDestinations#csrf-token=NWq4u3xGjbSouxdfGPPlWZxX4ZduaELmeb5xwmntCo7rxW/tb0vqRnU+Qun9Pk4EtquXWsW7ZDi7RqZaUkMQOw=="
          spellcheck="false"
          autocomplete="off"
          >
...
<a role="menuitem" class="dropdown-item" href="https://gist.github.com/" data-ga-click="Header, create new gist">
    ...
    <details class="details-overlay details-reset d-flex pl-2 flex-items-center">
      ...
      <details-menu class="dropdown-menu dropdown-menu-sw">
        <ul>
          ...
          <li>
            <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="logout-form" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="Ta6nCk7jAjvi5ymrMFdW20PERLMI+RB7UGioqTO0Ir0MPgjPycPSJQancU+5B2bgAjn4TlkByuPfRByVum5/vw==" />
        ...
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="sr-only right-0" action="/logout" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="RHFNzJKoxL6mAaAVkKCeHFQmHj6sYWIZvrLgtJkXa+8F4eIJFYgUoEJB+PEZ8K4nFduiw/2ZuIExnlSIEM027Q==" />
  ...
  <li>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form data-autosubmit="true" data-remote="true" class="js-social-container" action="/notifications/subscribe" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="qr9gHy+mL9Wlgr7FlF5eNDdgNZFo6tAtixqXrCv0xtmdAovBimT0ClGJnnQnqT8JFqm+EzFHtPQIdwggdX4Ntw==" />      <input type="hidden" name="repository_id" id="repository_id" value="138185210" class="form-control" />
  ...
  <div class="js-toggler-container js-social-container starring-container ">
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="starred js-social-form" action="/bhartigupta63/acadview-assignments/unstar" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="UjkFmaoiaRMQ5bw3ikOCN4gRti5vrLAIJeLsTG8RDIsA20I8vCYFcu/oBZj0pLH2dmDJ9/bFQwOMtaAZdoUKJg==" />
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="unstarred js-social-form" action="/bhartigupta63/acadview-assignments/star" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="XDz4XgDihttKwWztBYZ9rP4bwb4+ImBlVLAhssFINGm1qZoRBndWk1GY05aJA3DR4FzEZoff+QollFjy4lywDQ==" />
      <input type="hidden" name="context" value="repository"></input>
      <button
        type="submit"
        class="btn btn-sm btn-with-count js-toggler-target"
  ...
  <li>
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="btn-with-count" action="/bhartigupta63/acadview-assignments/fork" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="oNTtnFXRI+KZ/s2a8eQVxJb+tuAPSrNpg9A9Ga4ZH8hvxCiMX/uHNFIiF8Qx5Ql75U11q108Q/KwZYCzZ796Kg==" />
            <button
                type="submit"
...
<div class="container new-discussion-timeline experiment-repo-nav  ">
  ...
  <a class="d-none js-permalink-shortcut" data-hotkey="y" href="/bhartigupta63/acadview-assignments/blob/b763b085fee81dffd3dfab8af93d1ab594e7a65f/pandas.py">Permalink</a>

  <!-- blob contrib key: blob_contributors:v21:cf80a9edb22b3ce5722264d69ca23b59 -->
...
<div class="select-menu branch-select-menu js-menu-container js-select-menu float-left">
  ...
  <div class="select-menu-modal-holder js-menu-content js-navigation-container" data-pjax>
      ...
      <div class="select-menu-list select-menu-tab-bucket js-select-menu-tab-bucket" data-tab-filter="branches" role="menu">
        ...
        <div data-filterable-for="context-commitish-filter-field" data-filterable-type="substring">
            ...
            <a class="select-menu-item js-navigation-item js-navigation-open selected"
               href="/bhartigupta63/acadview-assignments/blob/master/pandas.py"
               data-name="master"
               data-skip-pjax="true"
               rel="nofollow">
              <svg class="octicon octicon-check select-menu-item-icon" viewBox="0 0 12 16" version="1.1" width="12" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M12 5l-8 8-4-4 1.5-1.5L4 10l6.5-6.5L12 5z"/></svg>
    ...
    <div id="blob-path" class="breadcrumb">
      <span class="repo-root js-repo-root"><span class="js-path-segment"><a data-pjax="true" href="/bhartigupta63/acadview-assignments"><span>acadview-assignments</span></a></span></span><span class="separator">/</span><strong class="final-path">pandas.py</strong>
    </div>
  </div>


  <include-fragment src="/bhartigupta63/acadview-assignments/contributors/master/pandas.py" class="commit-tease commit-loader">
    <div>
  ...
  <div class="file-actions">
    ...
    <div class="BtnGroup">
      <a id="raw-url" class="btn btn-sm BtnGroup-item" href="/bhartigupta63/acadview-assignments/raw/master/pandas.py">Raw</a>
        <a class="btn btn-sm js-update-url-with-hash BtnGroup-item" data-hotkey="b" href="/bhartigupta63/acadview-assignments/blame/master/pandas.py">Blame</a>
      <a rel="nofollow" class="btn btn-sm BtnGroup-item" href="/bhartigupta63/acadview-assignments/commits/master/pandas.py">History</a>
    </div>
        ...
        <a class="btn-octicon tooltipped tooltipped-nw"
          ...
          <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form js-update-url-with-hash" action="/bhartigupta63/acadview-assignments/edit/master/pandas.py" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="LrYmURlrBhVO2CsmUDVb8bl866W7S9+FQWZH8IIV1xQj5/PSYYYZG0HsY/WkFnd/D6YpQlOFjCnWANqCec98BQ==" />
            <button class="btn-octicon tooltipped tooltipped-nw" type="submit"
              aria-label="Fork this project and edit the file" data-hotkey="e" data-disable-with>
              <svg class="octicon octicon-pencil" viewBox="0 0 14 16" version="1.1" width="14" height="16" aria-hidden="true"><path fill-rule="evenodd" d="M0 12v3h3l8-8-3-3-8 8zm3 2H1v-2h1v1h1v1zm10.3-9.3L12 6 9 3l1.3-1.3a.996.996 0 0 1 1.41 0l1.59 1.59c.39.39.39 1.02 0 1.41z"/></svg>
            </button>
</form>
        <!-- '"` --><!-- </textarea></xmp> --></option></form><form class="inline-form" action="/bhartigupta63/acadview-assignments/delete/master/pandas.py" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="zgyUGpaV9/so6T8Dc+iqZTbVXSQtw0cRvbcLTZZbNCJonAX8hgZQXjg1Pe+sLzEdYuproE/zozxsEhGkKEbGkw==" />
  ...
  <div itemprop="text" class="blob-wrapper data type-python">
      ...
      <tr>
        ...
        <td id="LC5" class="blob-code blob-code-inner js-file-line">context <span class="pl-k">=</span> {</td>
      </tr>
      <tr>
        <td id="L6" class="blob-num js-line-number" data-line-number="6"></td>
        <td id="LC6" class="blob-code blob-code-inner js-file-line">           <span class="pl-s"><span class="pl-pds">&#39;</span>Name<span class="pl-pds">&#39;</span></span>:pd.Series([<span class="pl-s"><span class="pl-pds">&#39;</span>bharti<span class="pl-pds">&#39;</span></span>,<span class="pl-s"><span class="pl-pds">&#39;</span>ishaan<span class="pl-pds">&#39;</span></span>]),</td>
      </tr>
      <tr>
        <td id="L7" class="blob-num js-line-number" data-line-number="7"></td>
        <td id="LC7" class="blob-code blob-code-inner js-file-line">           <span class="pl-s"><span class="pl-pds">&#39;</span>Age<span class="pl-pds">&#39;</span></span>:pd.Series([<span class="pl-c1">21</span>,<span class="pl-c1">22</span>]),</td>
      </tr>
      <tr>
        <td id="L8" class="blob-num js-line-number" data-line-number="8"></td>
        <td id="LC8" class="blob-code blob-code-inner js-file-line">           <span class="pl-s"><span class="pl-pds">&#39;</span>Email<span class="pl-pds">&#39;</span></span>:pd.Series([<span class="pl-s"><span class="pl-pds">&#39;</span>bhartigupta63@gmail.com<span class="pl-pds">&#39;</span></span>,<span class="pl-s"><span class="pl-pds">&#39;</span>ishaankapoor1906@gmail.com<span class="pl-pds">&#39;</span></span>]),</td>
      </tr>
      <tr>
        <td id="L9" class="blob-num js-line-number" data-line-number="9"></td>
        <td id="LC9" class="blob-code blob-code-inner js-file-line">           <span class="pl-s"><span class="pl-pds">&#39;</span>Phone number<span class="pl-pds">&#39;</span></span>:pd.Series([<span class="pl-s"><span class="pl-pds">&#39;</span>9999999119<span class="pl-pds">&#39;</span></span>,<span class="pl-s"><span class="pl-pds">&#39;</span>9999999910<span class="pl-pds">&#39;</span></span>])</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC11" class="blob-code blob-code-inner js-file-line">df <span class="pl-k">=</span> pd.DataFrame(context)</td>
      </tr>
      <tr>
        <td id="L12" class="blob-num js-line-number" data-line-number="12"></td>
        <td id="LC12" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">print</span>(df)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC14" class="blob-code blob-code-inner js-file-line"><span class="pl-c"><span class="pl-c">#</span>2</span></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC19" class="blob-code blob-code-inner js-file-line"><span class="pl-v">file</span> <span class="pl-k">=</span> pd.read_csv(<span class="pl-s"><span class="pl-pds">&quot;</span>weather.csv<span class="pl-pds">&quot;</span></span>)</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC21" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">print</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>The first five rows of trhe dataframe are:<span class="pl-pds">&quot;</span></span>,<span class="pl-v">file</span>.head())</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC23" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">print</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>The first ten rows are:<span class="pl-pds">&quot;</span></span>,<span class="pl-v">file</span>.head(<span class="pl-c1">10</span>))</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC25" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">print</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>Basic statistics are:<span class="pl-pds">&quot;</span></span>,<span class="pl-v">file</span>.describe(<span class="pl-v">include</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">&#39;</span>all<span class="pl-pds">&#39;</span></span>))</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC27" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">print</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>The last five rows are:<span class="pl-pds">&quot;</span></span>,<span class="pl-v">file</span>.tail())</td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td id="LC29" class="blob-code blob-code-inner js-file-line"><span class="pl-c1">print</span>(<span class="pl-s"><span class="pl-pds">&quot;</span>Basic statistics of 2nd column is:<span class="pl-pds">&quot;</span></span>, <span class="pl-v">file</span>.describe(<span class="pl-v">include</span><span class="pl-k">=</span><span class="pl-s"><span class="pl-pds">&#39;</span>all<span class="pl-pds">&#39;</span></span>).Location)</td>
      </tr>
</table>
  ...
  <details class="details-reset details-overlay BlobToolbar position-absolute js-file-line-actions dropdown d-none" aria-hidden="true">
    ...
    <details-menu>
      <ul class="BlobToolbar-dropdown dropdown-menu dropdown-menu-se mt-2">
        ...
        <li><a class="dropdown-item js-update-url-with-hash" id="js-view-git-blame" role="menuitem" href="/bhartigupta63/acadview-assignments/blame/b763b085fee81dffd3dfab8af93d1ab594e7a65f/pandas.py">View git blame</a></li>
...
<div class="footer container-lg px-3" role="contentinfo">
  <div class="position-relative d-flex flex-justify-between pt-6 pb-2 mt-6 f6 text-gray border-top border-gray-light ">
    <ul class="list-style-none d-flex flex-wrap ">
      <li class="mr-3">&copy; 2018 <span title="0.26029s from unicorn-1948830130-wdh2b">GitHub</span>, Inc.</li>
